...
+ **Clethodim** (Group 1) is known for its good grass control in post-emergence applications.

+ However, **antagonistic interactions** have been reported when applied in **tank-mixtures with synthetic auxins** (Group 4).
